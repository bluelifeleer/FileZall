...
- [x] **Step 4: Wire startup behavior**
...
- [x] **Step 2: Verify the controller tests fail**
...
- [x] **Step 4: Add Test Connection action**
...
- [x] **Step 2: Verify the save-flow tests fail**
